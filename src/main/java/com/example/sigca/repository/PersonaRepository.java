...
public interface PersonaRepository extends JpaRepository<Persona, Integer>{
	...
	@Query(value = "{ CALL SP_UPD_TBL_PERSONA(:p_vID,:p_vNOMBRE,:p_vAPELLIDO_P,:p_vAPELLIDO_M,:p_vDNI,:p_vCORREO,:p_vTELEFONO) }", nativeQuery = true) 
	String actualizarPersona(@Param("p_vID") int p_vID, @Param("p_vNOMBRE") String p_vNOMBRE,
