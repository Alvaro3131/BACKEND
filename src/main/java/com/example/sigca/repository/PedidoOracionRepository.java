...
public interface PedidoOracionRepository extends JpaRepository<PedidoOracion, Integer>{
		...
		// Insertar
		@Query(value = "{call SP_INS_TBL_PEDIDOORACION(:p_vDE_PEDIDOORACION,:p_tPEDIDOORACION)}", nativeQuery = true) 
		String insertarPedidoOracion(@Param("p_vDE_PEDIDOORACION") String p_vDE_PEDIDOORACION, @Param("p_tPEDIDOORACION") String string);
